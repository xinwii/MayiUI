...
public class WaveView extends View {
    ...
    public static final int DEFAULT_BEHIND_WAVE_COLOR = Color.GRAY;
    public static final int DEFAULT_FRONT_WAVE_COLOR = Color.WHITE;
    ...
    private void createShader() {
        mDefaultAngularFrequency = 4.0f * Math.PI / DEFAULT_WAVE_LENGTH_RATIO / getWidth();
        mDefaultAmplitude = getHeight() * DEFAULT_AMPLITUDE_RATIO;
        mDefaultWaterLevel = getHeight() -mDefaultAmplitude*10;
        ...
        for (int beginX = 0; beginX < endX; beginX++) {
            ...
            float beginY = (float) (mDefaultWaterLevel + getHeight()*0.05 * Math.sin(wx));
        ...
        for (int beginX = 0; beginX < endX; beginX++) {
            double wx = beginX * mDefaultAngularFrequency/2;
            float beginY = (float) (mDefaultWaterLevel + getHeight()*0.05 * Math.sin(wx+getWidth()/2-20));
            canvas.drawLine(beginX, beginY, beginX, endY, wavePaint);
